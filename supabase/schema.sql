...
--
-- This file is the initial baseline only. Schema changes made after the
-- baseline was first applied belong in supabase/migrations/, not here —
-- add a new numbered file there and run it against the existing database.
